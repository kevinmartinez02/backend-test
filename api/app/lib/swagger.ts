      ...
      schemas: {
        ...
        StatusHistory: {
          ...
          properties: {
            ...
            fromStatus: {
              allOf: [{ $ref: "#/components/schemas/BookStatus" }],
              nullable: true,
            },
        ...
        BookUpdateInput: {
          type: "object",
          description:
            "All fields optional; only send what you want to change. Setting `rating` requires the book to be (or become) `read`. Sending `tags` replaces the full tag list.",
          properties: {
            title: { type: "string" },
            genre: { $ref: "#/components/schemas/BookGenre" },
            status: { $ref: "#/components/schemas/BookStatus" },
