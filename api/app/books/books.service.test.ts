...
async function newBook(
  overrides: { title?: string; genre?: Book_Genre; tags?: Array<string> } = {},
) {
...
describe("rating", () => {
  it("rechaza con 409 poner rating a un libro que no está en read", async () => {
    ...
    await expect(
      updateBook({ bookId: book.id, rating: 5 }),
